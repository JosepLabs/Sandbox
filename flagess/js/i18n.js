...
export const STR = {
  es: {
    ...
    helpBodyCapital: "En el modo Capitales adivinas escribiendo capitales en vez de países. La bandera se revela igual que en el modo Zoom con cada intento.",
  ...
  en: {
    ...
    helpBodyCapital: "In Capitals mode you guess by typing capital cities instead of countries. The flag reveals just like in Zoom mode with each attempt.",
